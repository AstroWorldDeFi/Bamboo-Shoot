...
function detectEthereumProvider({ mustBeMetaMask = false, silent = false, timeout = 3000, } = {}) {
    ...
    return new Promise((resolve) => {
        ...
        function handleEthereum() {
            ...
            if (ethereum && (!mustBeMetaMask || ethereum.isMetaMask)) {
                ...
                !silent && console.error('js/detect-provider.js:', message);
                resolve(null);
            }
        }
    });
    function _validateInputs() {
        if (typeof mustBeMetaMask !== 'boolean') {
            throw new Error(`js/detect-provider.js: Expected option 'mustBeMetaMask' to be a boolean.`);
        }
        if (typeof silent !== 'boolean') {
            throw new Error(`js/detect-provider.js: Expected option 'silent' to be a boolean.`);
        }
        if (typeof timeout !== 'number') {
            throw new Error(`js/detect-provider.js: Expected option 'timeout' to be a number.`);
        }
    }
}
